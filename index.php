...
if (isset($_SESSION["user_id"])) {
    ...
    $mysqli = require DIR . "/database.php";
...
<body onload='if (window.location.href.substr(window.location.href.length - 6) == "#about") { introAboutLogoTransition(); }'>
    ...
    <nav class="navbar glass" style="height: 70px;">
        ...
        <ul class="nav-links">
            ...
            <li><a href="login.php" class="cir_border">Login</a></li>
            <li><a href="signup.php" class="cir_border">Register</a></li>
        </ul>
            ...
            <div class="cbox">
                ...
                <div class="c_boxx">
                    <a href="mailto:abc@gmail.com"><i class="fa fa-envelope"></i>
                        Mail: manandharjenish83@gmail.com
                    </a>
                </div>
                <div class="c_boxx">
                    <a href="tel:+91-12345-67890"><i class="fa fa-phone"></i>
                        Phone: (+977) 9810143454
                    </a>
                </div>
                <div class="c_boxx">
    ...
    <section class="footer">
        <span>Created By Jenish Manandhar | &#169 2022 All rights reserved.</span>
        <div class="social">
            <li>
